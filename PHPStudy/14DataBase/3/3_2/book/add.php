<?php 
	...
	if(isset($_POST['dosubmit'])) {
		$sql = "insert into books(bookname, publisher, author, price, pic, detail, ptime) values('{$_POST['bookname']}', '{$_POST['publisher']}', '{$_POST['author']}', '{$_POST['price']}', 'picname', '{$_POST['detail']}', '".time()."')";
